...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT: (my comment) :because it requires an argument to initialize?
    # Why is this so? initializae has a required argument initial_name. If it had a default value then no error would occur.
  end
